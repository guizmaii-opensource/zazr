 ...
 */
public interface SortedMultimap<K extends @Nullable Object, V extends @Nullable Object> extends Multimap<K, V>, Ordered<K> {
    ...
    static <K extends @Nullable Object, V extends @Nullable Object> SortedMultimap<K, V> narrow(SortedMultimap<? extends K, ? extends V> map) {
    ...
    @Override
    <U extends @Nullable Object> SortedMultimap<K, V> distinctBy(Function<? super Tuple2<K, V>, ? extends U> keyExtractor);
    ...
    @Override
    <C extends @Nullable Object> Map<C, ? extends SortedMultimap<K, V>> groupBy(Function<? super Tuple2<K, V>, ? extends C> classifier);
