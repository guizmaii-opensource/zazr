...
public final class Predicates {
    ...
    /**
     * Returns a predicate that is satisfied only when <strong>all</strong> of the provided {@code predicates}
     * return {@code true} for a given input.
     *
     * <p>If no predicates are supplied, the resulting predicate always evaluates to {@code true}.</p>
     *
     * <pre>{@code
    ...
    @SafeVarargs
    public static <T extends @Nullable Object> Predicate<T> allOf(Predicate<T> ... predicates) {
        Objects.requireNonNull(predicates, "predicates is null");
        return t -> List.of(predicates).foldLeft(true, (bool, pred) -> bool && pred.test(t));
    }

    /**
     * Returns a predicate that is satisfied if <strong>at least one</strong> of the provided {@code predicates}
     * returns {@code true} for a given input.
     *
     * <p>If no predicates are supplied, the resulting predicate always evaluates to {@code false}.</p>
     *
     * <pre>{@code
     * Predicate<Integer> isGreaterThanOne = i -> i > 1;
     * Predicate<Integer> isGreaterThanTwo = i -> i > 2;
    ...
    @SuppressWarnings({"varargs" })
    @SafeVarargs
    public static <T extends @Nullable Object> Predicate<T> anyOf(Predicate<T> ... predicates) {
        Objects.requireNonNull(predicates, "predicates is null");
     ...
     *
     * <p>If the {@code Iterable} is empty, the resulting predicate evaluates to {@code false}.</p>
     *
     * <pre>{@code
     * Predicate<Integer> isGreaterThanOne = i -> i > 1;
     ...
     */
    public static <T extends @Nullable Object> Predicate<Iterable<T>> exists(Predicate<? super T> predicate) {
        Objects.requireNonNull(predicate, "predicate is null");
        return iterable -> Iterator.ofAll(iterable).exists(predicate);
    }

    /**
     * Returns a predicate that checks if <strong>all</strong> elements in an {@code Iterable}
     * satisfy the given {@code predicate}.
     *
     * <p>If the {@code Iterable} is empty, the resulting predicate evaluates to {@code true}.</p>
     *
     * <pre>{@code
     * Predicate<Integer> isGreaterThanOne = i -> i > 1;
     ...
     * @throws NullPointerException if {@code predicate} is null
     */
    public static <T extends @Nullable Object> Predicate<Iterable<T>> forAll(Predicate<? super T> predicate) {
        Objects.requireNonNull(predicate, "predicate is null");
        return iterable -> Iterator.ofAll(iterable).forAll(predicate);
    }

    /**
     * Returns a {@code Predicate} that tests whether an object is an instance of the specified {@code type}.
     *
     * <pre>{@code
    ...
    public static <T extends @Nullable Object> Predicate<T> instanceOf(Class<? extends T> type) {
     ...
     */
    public static <T extends @Nullable Object> Predicate<T> is(T value) {
        return obj -> Objects.equals(obj, value);
    }

    /**
     * Returns a {@code Predicate} that tests whether an object is equal to at least one of the specified {@code values},
     * using {@link Objects#equals(Object, Object)} for comparison.
     *
     * <pre>{@code
     ...
     * @param <T> the type of objects being tested
     * @return a predicate that evaluates to {@code true} if the tested object equals any of the specified {@code values}
     * @throws NullPointerException if {@code values} is null
     */
    @SuppressWarnings({"varargs" })
    @SafeVarargs
    public static <T extends @Nullable Object> Predicate<T> isIn(T ... values) {
    ...
    /**
     * Returns a predicate that is satisfied if <strong>none</strong> of the provided {@code predicates}
     * return {@code true} for a given input.
     *
     * <p>If no predicates are supplied, the resulting predicate always evaluates to {@code true}.</p>
     *
    ...
    @SuppressWarnings({"varargs" })
    @SafeVarargs
    public static <T extends @Nullable Object> Predicate<T> noneOf(Predicate<T> ... predicates) {
        Objects.requireNonNull(predicates, "predicates is null");
     ...
     * @param <T> the type of objects being tested
     * @return a predicate that evaluates to {@code true} if the original predicate evaluates to {@code false}, and vice versa
     * @throws NullPointerException if {@code predicate} is null
     */
    @SuppressWarnings("unchecked")
    public static <T extends @Nullable Object> Predicate<T> not(Predicate<? super T> predicate) {
        Objects.requireNonNull(predicate, "predicate is null");
