...
keep on 21, and `<java.version>` in `pom.xml`, the CI matrix (baseline 25, the released versions above it, and the current early-access build; `25, 26, 27, 28-ea` as of September 2026) and the release workflow
