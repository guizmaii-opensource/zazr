...
- Once the coordinator is satisfied with a PR, **one independent review** is launched: a fresh agent
  ...
  edge cases, and the tests that would have caught them. It runs no benchmarks and reports nothing
  about performance, documentation wording or style; those are the coordinator's review. Its findings
