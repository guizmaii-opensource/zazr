...
public class PropertyCheck3Test {
    ...
    public void shouldRejectNullResultPredicate3() {
        assertThrows(NullPointerException.class, () -> Property.def("test").forAll(OBJECTS, OBJECTS, OBJECTS).suchThatResult(null));
    }
    ...
    public void shouldRejectNullResultPostcondition3() {
        assertThrows(NullPointerException.class, () -> Property.def("test").forAll(OBJECTS, OBJECTS, OBJECTS).suchThat((o1, o2, o3) -> true).impliesResult(null));
    }
