...
public class PropertyCheck4Test {
    ...
    public void shouldRejectNullResultPredicate4() {
        assertThrows(NullPointerException.class, () -> Property.def("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS).suchThatResult(null));
    }
    ...
    public void shouldRejectNullResultPostcondition4() {
        assertThrows(NullPointerException.class, () -> Property.def("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS).suchThat((o1, o2, o3, o4) -> true).impliesResult(null));
    }
