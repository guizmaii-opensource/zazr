...
import com.guizmaii.zazr.CheckedFunction4;
...
public class PropertyCheck4Test {
    ...
    public void shouldApplyForAllOfArity4() {
        final Property.ForAll4<Object, Object, Object, Object> forAll = Property.named("test").forAll(null, null, null, null);
        assertThat(forAll).isNotNull();
    }

    @Test
    public void shouldApplySuchThatOfArity4() {
        final Property.ForAll4<Object, Object, Object, Object> forAll = Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS);
    ...
    public void shouldCheckSuccessfulPredicateResult4() {
        final CheckResult result = Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS)
    ...
    public void shouldRejectNullResultPredicate4() {
        assertThrows(NullPointerException.class, () -> Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS).suchThatResult(null));
    }
    ...
    public void shouldDiscardRejectedPreconditionMessage4() {
        final Property.Property4<Object, Object, Object, Object> property = Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS)
    ...
    public void shouldRejectNullResultPostcondition4() {
        assertThrows(NullPointerException.class, () -> Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS).suchThat((o1, o2, o3, o4) -> true).impliesResult(null));
    }
