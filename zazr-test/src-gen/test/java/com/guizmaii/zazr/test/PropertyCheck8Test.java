...
import com.guizmaii.zazr.CheckedFunction8;
...
public class PropertyCheck8Test {
    ...
    public void shouldApplyForAllOfArity8() {
        final Property.ForAll8<Object, Object, Object, Object, Object, Object, Object, Object> forAll = Property.named("test").forAll(null, null, null, null, null, null, null, null);
        assertThat(forAll).isNotNull();
    }

    @Test
    public void shouldApplySuchThatOfArity8() {
        final Property.ForAll8<Object, Object, Object, Object, Object, Object, Object, Object> forAll = Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS);
    ...
    public void shouldCheckSuccessfulPredicateResult8() {
        final CheckResult result = Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS)
    ...
    public void shouldRejectNullResultPredicate8() {
        assertThrows(NullPointerException.class, () -> Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS).suchThatResult(null));
    }
    ...
    public void shouldDiscardRejectedPreconditionMessage8() {
        final Property.Property8<Object, Object, Object, Object, Object, Object, Object, Object> property = Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS)
    ...
    public void shouldRejectNullResultPostcondition8() {
        assertThrows(NullPointerException.class, () -> Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS).suchThat((o1, o2, o3, o4, o5, o6, o7, o8) -> true).impliesResult(null));
    }
