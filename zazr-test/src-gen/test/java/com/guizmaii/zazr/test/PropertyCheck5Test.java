...
public class PropertyCheck5Test {
    ...
    public void shouldRejectNullResultPredicate5() {
        assertThrows(NullPointerException.class, () -> Property.def("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS).suchThatResult(null));
    }
    ...
    public void shouldRejectNullResultPostcondition5() {
        assertThrows(NullPointerException.class, () -> Property.def("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS).suchThat((o1, o2, o3, o4, o5) -> true).impliesResult(null));
    }
