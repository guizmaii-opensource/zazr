...
import com.guizmaii.zazr.CheckedFunction5;
...
public class PropertyCheck5Test {
    ...
    public void shouldApplyForAllOfArity5() {
        final Property.ForAll5<Object, Object, Object, Object, Object> forAll = Property.named("test").forAll(null, null, null, null, null);
        assertThat(forAll).isNotNull();
    }

    @Test
    public void shouldApplySuchThatOfArity5() {
        final Property.ForAll5<Object, Object, Object, Object, Object> forAll = Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS);
    ...
    public void shouldCheckSuccessfulPredicateResult5() {
        final CheckResult result = Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS)
    ...
    public void shouldRejectNullResultPredicate5() {
        assertThrows(NullPointerException.class, () -> Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS).suchThatResult(null));
    }
    ...
    public void shouldDiscardRejectedPreconditionMessage5() {
        final Property.Property5<Object, Object, Object, Object, Object> property = Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS)
    ...
    public void shouldRejectNullResultPostcondition5() {
        assertThrows(NullPointerException.class, () -> Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS).suchThat((o1, o2, o3, o4, o5) -> true).impliesResult(null));
    }
