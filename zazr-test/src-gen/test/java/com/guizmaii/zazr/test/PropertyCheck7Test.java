...
public class PropertyCheck7Test {
    ...
    public void shouldRejectNullResultPredicate7() {
        assertThrows(NullPointerException.class, () -> Property.def("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS).suchThatResult(null));
    }
    ...
    public void shouldRejectNullResultPostcondition7() {
        assertThrows(NullPointerException.class, () -> Property.def("test").forAll(OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS, OBJECTS).suchThat((o1, o2, o3, o4, o5, o6, o7) -> true).impliesResult(null));
    }
