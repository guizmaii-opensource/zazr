...
public class PropertyCheck3Test {
    ...
    public void shouldApplyForAllOfArity3() {
        final Property.ForAll3<Object, Object, Object> forAll = Property.named("test").forAll(null, null, null);
        assertThat(forAll).isNotNull();
    }

    @Test
    public void shouldApplySuchThatOfArity3() {
        final Property.ForAll3<Object, Object, Object> forAll = Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS);
    ...
    public void shouldCheckSuccessfulPredicateResult3() {
        final CheckResult result = Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS)
    ...
    public void shouldRejectNullResultPredicate3() {
        assertThrows(NullPointerException.class, () -> Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS).suchThatResult(null));
    }
    ...
    public void shouldDiscardRejectedPreconditionMessage3() {
        final Property.Property3<Object, Object, Object> property = Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS)
    ...
    public void shouldRejectNullResultPostcondition3() {
        assertThrows(NullPointerException.class, () -> Property.named("test").forAll(OBJECTS, OBJECTS, OBJECTS).suchThat((o1, o2, o3) -> true).impliesResult(null));
    }
