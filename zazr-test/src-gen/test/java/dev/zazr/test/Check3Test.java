...
class Check3Test {
    ...
    void falseFalsifiesTheCheck() {
        assertThat(Check.evaluate(CONFIG, Gen.constant(1), Gen.constant(2), Gen.constant(3), (v1, v2, v3) -> false))
                .isEqualTo(new CheckResult.Falsified(1, 42L, Tuple.of(1, 2, 3), Option.none()));
        assertThat(Check.evaluateAll(CONFIG, TWO, TWO, TWO, (v1, v2, v3) -> v1 + v2 + v3 < 3))
    ...
    void checkReturnsWhenEveryValuePasses() {
        ...
        Check.checkAll(TWO, TWO, TWO, (v1, v2, v3) -> true);
        Check.checkAll(CONFIG, TWO, TWO, TWO, (v1, v2, v3) -> true);
    }
    ...
    void rejectsNulls() {
        ...
        assertThatThrownBy(() -> Check.evaluate(CONFIG, Gen.constant(1), Gen.constant(2), Gen.constant(3), null)).isInstanceOf(NullPointerException.class);
        ...
        assertThatThrownBy(() -> Check.evaluateAll(CONFIG, Gen.constant(1), Gen.constant(2), Gen.constant(3), null)).isInstanceOf(NullPointerException.class);
