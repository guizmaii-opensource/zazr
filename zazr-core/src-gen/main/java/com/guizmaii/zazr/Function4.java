...
public interface Function4<T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, R extends @Nullable Object>  {
     ...
     */
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, R extends @Nullable Object> Function4<T1, T2, T3, T4, R> constant(R value) {
     ...
     * </ul>
     *
     * Examples (w.l.o.g. referring to Function4):
     * <pre>{@code // using a lambda expression
     * Function4<T1, T2, T3, T4, R> add1 = Function4.of((t1, t2, t3, t4) -> t1 + t2 + t3 + t4);
     *
     * // using a method reference
     * Function4<T1, T2, T3, T4, R> add2 = Function4.of(this::method);
     *
     * // using a lambda reference
     * Function4<T1, T2, T3, T4, R> add3 = Function4.of(add1::apply);
     * }</pre>
     *
     ...
     */
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, R extends @Nullable Object> Function4<T1, T2, T3, T4, R> of(Function4<T1, T2, T3, T4, R> methodReference) {
     ...
     */
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, R extends @Nullable Object> Function4<T1, T2, T3, T4, Option<R>> lift(Function4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> partialFunction) {
        return (t1, t2, t3, t4) -> {
            try {
     ...
     */
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, R extends @Nullable Object> Function4<T1, T2, T3, T4, Try<R>> liftTry(Function4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> partialFunction) {
    ...
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, R extends @Nullable Object> Function4<T1, T2, T3, T4, R> narrow(Function4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> f) {
     ...
     */
    default Function<T1, Function<T2, Function<T3, Function<T4, R>>>> curried() {
     ...
     */
    default Function<Tuple4<T1, T2, T3, T4>, R> tupled() {
        return t -> apply(t._1(), t._2(), t._3(), t._4());
    }

    /**
     * Returns a composed function that first applies this Function4 to the given arguments and then applies
     ...
     */
    default <V extends @Nullable Object> Function4<T1, T2, T3, T4, V> andThen(Function<? super R, ? extends V> after) {
     ...
     */
    default <S extends @Nullable Object> Function4<S, T2, T3, T4, R> compose1(Function<? super S, ? extends T1> before) {
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> Function4<T1, S, T3, T4, R> compose2(Function<? super S, ? extends T2> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> Function4<T1, T2, S, T4, R> compose3(Function<? super S, ? extends T3> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> Function4<T1, T2, T3, S, R> compose4(Function<? super S, ? extends T4> before) {
        Objects.requireNonNull(before, "before is null");
