...
import static com.guizmaii.zazr.CheckedFunction7Module.sneakyThrow;
 ...
 */
@FunctionalInterface
public interface CheckedFunction7<T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, T6 extends @Nullable Object, T7 extends @Nullable Object, R extends @Nullable Object>  {
     ...
     */
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, T6 extends @Nullable Object, T7 extends @Nullable Object, R extends @Nullable Object> CheckedFunction7<T1, T2, T3, T4, T5, T6, T7, R> constant(R value) {
     ...
     * </ul>
     *
     * Examples (w.l.o.g. referring to CheckedFunction7):
     * <pre>{@code // using a lambda expression
     * CheckedFunction7<T1, T2, T3, T4, T5, T6, T7, R> add1 = CheckedFunction7.of((t1, t2, t3, t4, t5, t6, t7) -> t1 + t2 + t3 + t4 + t5 + t6 + t7);
     *
     * // using a method reference
     * CheckedFunction7<T1, T2, T3, T4, T5, T6, T7, R> add2 = CheckedFunction7.of(this::method);
     *
     * // using a lambda reference
     * CheckedFunction7<T1, T2, T3, T4, T5, T6, T7, R> add3 = CheckedFunction7.of(add1::apply);
     * }</pre>
     *
     ...
     */
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, T6 extends @Nullable Object, T7 extends @Nullable Object, R extends @Nullable Object> CheckedFunction7<T1, T2, T3, T4, T5, T6, T7, R> of(CheckedFunction7<T1, T2, T3, T4, T5, T6, T7, R> methodReference) {
     ...
     */
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, T6 extends @Nullable Object, T7 extends @Nullable Object, R extends @Nullable Object> Function7<T1, T2, T3, T4, T5, T6, T7, Option<R>> lift(CheckedFunction7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> partialFunction) {
        return (t1, t2, t3, t4, t5, t6, t7) -> Try.<R>of(() -> { try { return partialFunction.apply(t1, t2, t3, t4, t5, t6, t7); } catch (Throwable t) { return sneakyThrow(t); } }).toOption();
    }
     ...
     */
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, T6 extends @Nullable Object, T7 extends @Nullable Object, R extends @Nullable Object> Function7<T1, T2, T3, T4, T5, T6, T7, Try<R>> liftTry(CheckedFunction7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> partialFunction) {
        return (t1, t2, t3, t4, t5, t6, t7) -> Try.of(() -> { try { return partialFunction.apply(t1, t2, t3, t4, t5, t6, t7); } catch (Throwable t) { return sneakyThrow(t); } });
    }
    ...
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, T6 extends @Nullable Object, T7 extends @Nullable Object, R extends @Nullable Object> CheckedFunction7<T1, T2, T3, T4, T5, T6, T7, R> narrow(CheckedFunction7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> f) {
     ...
     */
    default Function<T1, Function<T2, Function<T3, Function<T4, Function<T5, Function<T6, CheckedFunction1<T7, R>>>>>>> curried() {
    ...
    /**
     * Returns a composed function that first applies this CheckedFunction7 to the given arguments and then applies
     ...
     */
    default <V extends @Nullable Object> CheckedFunction7<T1, T2, T3, T4, T5, T6, T7, V> andThen(CheckedFunction1<? super R, ? extends V> after) {
     ...
     */
    default <S extends @Nullable Object> CheckedFunction7<S, T2, T3, T4, T5, T6, T7, R> compose1(Function<? super S, ? extends T1> before) {
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> CheckedFunction7<T1, S, T3, T4, T5, T6, T7, R> compose2(Function<? super S, ? extends T2> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> CheckedFunction7<T1, T2, S, T4, T5, T6, T7, R> compose3(Function<? super S, ? extends T3> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> CheckedFunction7<T1, T2, T3, S, T5, T6, T7, R> compose4(Function<? super S, ? extends T4> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> CheckedFunction7<T1, T2, T3, T4, S, T6, T7, R> compose5(Function<? super S, ? extends T5> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> CheckedFunction7<T1, T2, T3, T4, T5, S, T7, R> compose6(Function<? super S, ? extends T6> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> CheckedFunction7<T1, T2, T3, T4, T5, T6, S, R> compose7(Function<? super S, ? extends T7> before) {
        Objects.requireNonNull(before, "before is null");
