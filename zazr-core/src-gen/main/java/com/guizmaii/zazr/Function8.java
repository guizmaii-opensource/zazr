...
public interface Function8<T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, T6 extends @Nullable Object, T7 extends @Nullable Object, T8 extends @Nullable Object, R extends @Nullable Object>  {
     ...
     * </ul>
     *
     * Examples (w.l.o.g. referring to Function8):
     * <pre>{@code // using a lambda expression
     * Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> add1 = Function8.of((t1, t2, t3, t4, t5, t6, t7, t8) -> t1 + t2 + t3 + t4 + t5 + t6 + t7 + t8);
     *
     * // using a method reference
     * Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> add2 = Function8.of(this::method);
     *
     * // using a lambda reference
     * Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> add3 = Function8.of(add1::apply);
     * }</pre>
     *
     ...
     */
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, T6 extends @Nullable Object, T7 extends @Nullable Object, T8 extends @Nullable Object, R extends @Nullable Object> Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> of(Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> methodReference) {
     ...
     */
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, T6 extends @Nullable Object, T7 extends @Nullable Object, T8 extends @Nullable Object, R extends @Nullable Object> Function8<T1, T2, T3, T4, T5, T6, T7, T8, Option<R>> lift(Function8<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> partialFunction) {
     ...
     */
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, T6 extends @Nullable Object, T7 extends @Nullable Object, T8 extends @Nullable Object, R extends @Nullable Object> Function8<T1, T2, T3, T4, T5, T6, T7, T8, Try<R>> liftTry(Function8<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> partialFunction) {
     ...
     * @return a partial application of this function
     */
    default BiFunction<T7, T8, R> apply(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6) {
     ...
     * @return a partial application of this function
     */
    default Function<T8, R> apply(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7) {
     ...
     */
    default Function<T1, Function<T2, Function<T3, Function<T4, Function<T5, Function<T6, Function<T7, Function<T8, R>>>>>>>> curried() {
     ...
     */
    default Function<Tuple8<T1, T2, T3, T4, T5, T6, T7, T8>, R> tupled() {
        return t -> apply(t._1(), t._2(), t._3(), t._4(), t._5(), t._6(), t._7(), t._8());
    }

    /**
     * Returns a composed function that first applies this Function8 to the given arguments and then applies
     ...
     */
    default <V extends @Nullable Object> Function8<T1, T2, T3, T4, T5, T6, T7, T8, V> andThen(Function<? super R, ? extends V> after) {
     ...
     */
    default <S extends @Nullable Object> Function8<S, T2, T3, T4, T5, T6, T7, T8, R> compose1(Function<? super S, ? extends T1> before) {
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> Function8<T1, S, T3, T4, T5, T6, T7, T8, R> compose2(Function<? super S, ? extends T2> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> Function8<T1, T2, S, T4, T5, T6, T7, T8, R> compose3(Function<? super S, ? extends T3> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> Function8<T1, T2, T3, S, T5, T6, T7, T8, R> compose4(Function<? super S, ? extends T4> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> Function8<T1, T2, T3, T4, S, T6, T7, T8, R> compose5(Function<? super S, ? extends T5> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> Function8<T1, T2, T3, T4, T5, S, T7, T8, R> compose6(Function<? super S, ? extends T6> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> Function8<T1, T2, T3, T4, T5, T6, S, T8, R> compose7(Function<? super S, ? extends T7> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> Function8<T1, T2, T3, T4, T5, T6, T7, S, R> compose8(Function<? super S, ? extends T8> before) {
        Objects.requireNonNull(before, "before is null");
