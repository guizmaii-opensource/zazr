 ...
 */
@FunctionalInterface
public interface CheckedFunction5<T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, R extends @Nullable Object>  {
     ...
     */
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, R extends @Nullable Object> CheckedFunction5<T1, T2, T3, T4, T5, R> constant(R value) {
     ...
     * </ul>
     *
     * Examples (w.l.o.g. referring to CheckedFunction5):
     * <pre>{@code // using a lambda expression
     * CheckedFunction5<T1, T2, T3, T4, T5, R> add1 = CheckedFunction5.of((t1, t2, t3, t4, t5) -> t1 + t2 + t3 + t4 + t5);
     *
     * // using a method reference
     * CheckedFunction5<T1, T2, T3, T4, T5, R> add2 = CheckedFunction5.of(this::method);
     *
     * // using a lambda reference
     * CheckedFunction5<T1, T2, T3, T4, T5, R> add3 = CheckedFunction5.of(add1::apply);
     * }</pre>
     *
     ...
     */
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, R extends @Nullable Object> CheckedFunction5<T1, T2, T3, T4, T5, R> of(CheckedFunction5<T1, T2, T3, T4, T5, R> methodReference) {
    ...
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, R extends @Nullable Object> CheckedFunction5<T1, T2, T3, T4, T5, R> narrow(CheckedFunction5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> f) {
     ...
     */
    default Function<T1, Function<T2, Function<T3, Function<T4, CheckedFunction1<T5, R>>>>> curried() {
    ...
    /**
     * Return a composed function that first applies this CheckedFunction5 to the given arguments and in case of a
    ...
    default Function5<T1, T2, T3, T4, T5, R> recover(Function<? super Throwable, ? extends Function5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R>> recover) {
        ...
        return (t1, t2, t3, t4, t5) -> {
            try {
                ...
                if (func == null) {
                    final NullPointerException nullResult = new NullPointerException("CheckedFunction5.recover: recover returned null");
    ...
    /**
     * Returns a composed function that first applies this CheckedFunction5 to the given arguments and then applies
     ...
     */
    default <V extends @Nullable Object> CheckedFunction5<T1, T2, T3, T4, T5, V> andThen(CheckedFunction1<? super R, ? extends V> after) {
     ...
     */
    default <S extends @Nullable Object> CheckedFunction5<S, T2, T3, T4, T5, R> compose1(Function<? super S, ? extends T1> before) {
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> CheckedFunction5<T1, S, T3, T4, T5, R> compose2(Function<? super S, ? extends T2> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> CheckedFunction5<T1, T2, S, T4, T5, R> compose3(Function<? super S, ? extends T3> before) {
        Objects.requireNonNull(before, "before is null");
     ...
     * @throws NullPointerException if before is null
     */
    default <S extends @Nullable Object> CheckedFunction5<T1, T2, T3, S, T5, R> compose4(Function<? super S, ? extends T4> before) {
        Objects.requireNonNull(before, "before is null");
