...
import static com.guizmaii.zazr.CheckedFunction4Module.sneakyThrow;
...
public interface CheckedFunction4<T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, R extends @Nullable Object>  {
     ...
     * </ul>
     *
     * Examples (w.l.o.g. referring to CheckedFunction4):
     * <pre>{@code // using a lambda expression
     * CheckedFunction4<T1, T2, T3, T4, R> add1 = CheckedFunction4.of((t1, t2, t3, t4) -> t1 + t2 + t3 + t4);
     *
     * // using a method reference
     * CheckedFunction4<T1, T2, T3, T4, R> add2 = CheckedFunction4.of(this::method);
     *
     * // using a lambda reference
     * CheckedFunction4<T1, T2, T3, T4, R> add3 = CheckedFunction4.of(add1::apply);
     * }</pre>
     *
    ...
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, R extends @Nullable Object> Function4<T1, T2, T3, T4, Option<R>> lift(CheckedFunction4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> partialFunction) {
        return (t1, t2, t3, t4) -> Try.<R>of(() -> { try { return partialFunction.apply(t1, t2, t3, t4); } catch (Throwable t) { return sneakyThrow(t); } }).toOption();
    }
    ...
    static <T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, R extends @Nullable Object> Function4<T1, T2, T3, T4, Try<R>> liftTry(CheckedFunction4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> partialFunction) {
        return (t1, t2, t3, t4) -> Try.of(() -> { try { return partialFunction.apply(t1, t2, t3, t4); } catch (Throwable t) { return sneakyThrow(t); } });
    }
     ...
     */
    default Function<T1, Function<T2, Function<T3, CheckedFunction1<T4, R>>>> curried() {
    ...
    /**
     * Returns a composed function that first applies this CheckedFunction4 to the given arguments and then applies
