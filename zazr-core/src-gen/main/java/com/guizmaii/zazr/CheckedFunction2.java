...
public interface CheckedFunction2<T1 extends @Nullable Object, T2 extends @Nullable Object, R extends @Nullable Object>  {
    ...
    /**
     * Return a composed function that first applies this CheckedFunction2 to the given arguments and in case of a
    ...
    default BiFunction<T1, T2, R> recover(Function<? super Throwable, ? extends BiFunction<? super T1, ? super T2, ? extends R>> recover) {
        ...
        return (t1, t2) -> {
            try {
                ...
                if (func == null) {
                    final NullPointerException nullResult = new NullPointerException("CheckedFunction2.recover: recover returned null");
