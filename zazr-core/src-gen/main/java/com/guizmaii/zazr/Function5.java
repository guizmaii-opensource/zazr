...
public interface Function5<T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, R extends @Nullable Object>  {
     ...
     * </ul>
     *
     * Examples (w.l.o.g. referring to Function5):
     * <pre>{@code // using a lambda expression
     * Function5<T1, T2, T3, T4, T5, R> add1 = Function5.of((t1, t2, t3, t4, t5) -> t1 + t2 + t3 + t4 + t5);
     *
     * // using a method reference
     * Function5<T1, T2, T3, T4, T5, R> add2 = Function5.of(this::method);
     *
     * // using a lambda reference
     * Function5<T1, T2, T3, T4, T5, R> add3 = Function5.of(add1::apply);
     * }</pre>
     *
     ...
     * @return a partial application of this function
     */
    default BiFunction<T4, T5, R> apply(T1 t1, T2 t2, T3 t3) {
     ...
     * @return a partial application of this function
     */
    default Function<T5, R> apply(T1 t1, T2 t2, T3 t3, T4 t4) {
     ...
     */
    default Function<T1, Function<T2, Function<T3, Function<T4, Function<T5, R>>>>> curried() {
     ...
     */
    default Function<Tuple5<T1, T2, T3, T4, T5>, R> tupled() {
