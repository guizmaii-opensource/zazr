 ...
 */
@FunctionalInterface
public interface CheckedFunction6<T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, T6 extends @Nullable Object, R extends @Nullable Object>  {
    ...
    /**
     * Return a composed function that first applies this CheckedFunction6 to the given arguments and in case of a
    ...
    default Function6<T1, T2, T3, T4, T5, T6, R> recover(Function<? super Throwable, ? extends Function6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? extends R>> recover) {
        ...
        return (t1, t2, t3, t4, t5, t6) -> {
            try {
                ...
                if (func == null) {
                    final NullPointerException nullResult = new NullPointerException("CheckedFunction6.recover: recover returned null");
    ...
    /**
     * Returns a composed function that first applies this CheckedFunction6 to the given arguments and then applies
