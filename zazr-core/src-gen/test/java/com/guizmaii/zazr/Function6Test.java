...
public class Function6Test {
    ...
    public void shouldLiftPartialFunction() {
        final Function6<Integer, Integer, Integer, Integer, Integer, Integer, Option<Integer>> lifted = Function6.lift((i1, i2, i3, i4, i5, i6) -> {
            if (i1 == 0) {
                return null;
            }
            if (i1 == 1) {
    ...
    public void shouldRethrowFatalThrowableFromLiftTry() {
        final Function6<Integer, Integer, Integer, Integer, Integer, Integer, Try<Integer>> lifted =
            Function6.liftTry((i1, i2, i3, i4, i5, i6) -> { throw new OutOfMemoryError("fatal"); });
    ...
    public void shouldReturnFailureFromLiftTryOnNonFatalThrowable() {
        final Function6<Integer, Integer, Integer, Integer, Integer, Integer, Try<Integer>> lifted =
            Function6.liftTry((i1, i2, i3, i4, i5, i6) -> { throw new IllegalStateException("non-fatal"); });
    ...
    public void shouldPartiallyApply() {
        final Function6<Object, Object, Object, Object, Object, Object, Object> f = (o1, o2, o3, o4, o5, o6) -> "" + o1 + o2 + o3 + o4 + o5 + o6;
