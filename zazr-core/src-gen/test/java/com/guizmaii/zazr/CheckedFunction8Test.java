...
public class CheckedFunction8Test {
    ...
    public void shouldLiftPartialFunction() {
        final Function8<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Option<Integer>> lifted = CheckedFunction8.lift((i1, i2, i3, i4, i5, i6, i7, i8) -> {
            if (i1 == 0) {
                return null;
            }
            if (i1 == 1) {
    ...
    public void shouldRethrowFatalThrowableFromLiftTry() {
        final Function8<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Try<Integer>> lifted =
            CheckedFunction8.liftTry((i1, i2, i3, i4, i5, i6, i7, i8) -> { throw new OutOfMemoryError("fatal"); });
    ...
    public void shouldReturnFailureFromLiftTryOnNonFatalThrowable() {
        final Function8<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Try<Integer>> lifted =
            CheckedFunction8.liftTry((i1, i2, i3, i4, i5, i6, i7, i8) -> { throw new Exception("non-fatal"); });
    ...
    public void shouldPartiallyApply() throws Exception {
        final CheckedFunction8<Object, Object, Object, Object, Object, Object, Object, Object, Object> f = (o1, o2, o3, o4, o5, o6, o7, o8) -> "" + o1 + o2 + o3 + o4 + o5 + o6 + o7 + o8;
