...
public class QueueTest extends AbstractTraversableTest {
    ...
    class BothEndsTests {
        ...
        public void shouldRebalanceTheRearIntoTheFrontOnDequeue() {
            ...
            assertThat(queue.reverse().toList()).isEqualTo(dev.zazr.collection.List.of(5, 4));
        }
        ...
        public void shouldReadAcrossTheFrontRearBoundary() {
            ...
            assertThat(queue.reverse().toList()).isEqualTo(dev.zazr.collection.List.of(4, 3, 2, 1));
            assertThat(queue.drop(2).toList()).isEqualTo(dev.zazr.collection.List.of(3, 4));
