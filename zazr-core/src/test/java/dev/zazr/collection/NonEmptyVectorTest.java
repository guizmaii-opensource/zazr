...
public class NonEmptyVectorTest {
    ...
    class ReturnsNonEmptyVectorLikeVector {
        ...
        public void shouldUnzipIntoNonEmptyVectors(int n, Vector<Integer> vector) {
            ...
            final dev.zazr.Tuple3<NonEmptyVector<Integer>, NonEmptyVector<String>, NonEmptyVector<Long>> unzipped3 = nev.unzip3(i -> Tuple.of(i, "s" + i, (long) i));
            final dev.zazr.Tuple3<Vector<Integer>, Vector<String>, Vector<Long>> expected3 = vector.unzip3(i -> Tuple.of(i, "s" + i, (long) i));
