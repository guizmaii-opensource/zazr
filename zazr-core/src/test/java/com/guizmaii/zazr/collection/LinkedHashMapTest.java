...
public class LinkedHashMapTest extends AbstractMapTest {
    ...
    public void shouldScanLeft() {
        final Map<Integer, String> map = this.<Integer, String> emptyMap()
                ...
                .put(Tuple.of(3, "c"))
                .put(Tuple.of(4, "d"));
        final List<Tuple2<Integer, String>> result = map.scanLeft(Tuple.of(0, "x"), (t1, t2) -> Tuple.of(t1._1() + t2._1(), t1._2() + t2._2()));
    ...
    public void shouldScanRight() {
        final Map<Integer, String> map = this.<Integer, String> emptyMap()
                ...
                .put(Tuple.of(3, "c"))
                .put(Tuple.of(4, "d"));
        final List<Tuple2<Integer, String>> result = map.scanRight(Tuple.of(0, "x"), (t1, t2) -> Tuple.of(t1._1() + t2._1(), t1._2() + t2._2()));
        assertThat(result).isEqualTo(List.of(
                Tuple.of(10, "abcdx"),
                Tuple.of(9, "bcdx"),
                Tuple.of(7, "cdx"),
