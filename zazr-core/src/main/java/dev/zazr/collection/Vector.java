...
import dev.zazr.collection.internal.RadixVector;
import dev.zazr.collection.internal.TraversableModule;
import dev.zazr.collection.internal.VectorBuilder;
import dev.zazr.collection.internal.VectorModule;
import dev.zazr.collection.internal.VectorModule.Combinations;
...
import static dev.zazr.collection.internal.Collections.withSize;
...
public final class Vector<T extends @Nullable Object> implements Traversable<T> {
    ...
    public static <T extends @Nullable Object> Vector<T> ofAll(Iterable<? extends T> iterable) {
        ...
        if (iterable instanceof Traversable && dev.zazr.collection.internal.Collections.isEmpty(iterable)) {
            return empty();
        }
    ...
    public static <T extends @Nullable Object> Vector<Vector<T>> transpose(Vector<Vector<T>> matrix) {
        return dev.zazr.collection.internal.Collections.transpose(matrix, Vector::ofAll, Vector::of);
    }
    ...
    public Vector<T> shuffle() {
        return dev.zazr.collection.internal.Collections.shuffle(this, Vector::ofAll);
    }
