...
public final class Queue<T extends @Nullable Object> implements Traversable<T> {
    ...
    public static <T extends @Nullable Object> Queue<T> of(T element) {
        return ofAll(dev.zazr.collection.List.of(element));
    }
    ...
    public static <T extends @Nullable Object> Queue<T> ofAll(Iterable<? extends T> elements) {
        ...
        } else if (JavaConverters.underlying(elements) instanceof Queue<?> underlying) {
    ...
    public static <T extends @Nullable Object> Queue<T> ofAll(java.util.stream.Stream<? extends T> javaStream) {
        ...
        return new Queue<>(dev.zazr.collection.List.ofAll(javaStream), dev.zazr.collection.List.empty());
    }
    ...
    public static <T extends @Nullable Object> Queue<T> flatten(Iterable<? extends Iterable<? extends T>> nested) {
        ...
        return reversed.isEmpty() ? empty() : new Queue<>(reversed.reverse(), dev.zazr.collection.List.empty());
    }
    ...
    public static <T extends @Nullable Object> Queue<T> tabulate(int n, Function<? super Integer, ? extends T> f) {
        ...
        return dev.zazr.collection.internal.Collections.tabulate(n, f, empty(), Queue::of);
    }
    ...
    public static <T extends @Nullable Object> Queue<T> fill(int n, Supplier<? extends T> s) {
        ...
        return dev.zazr.collection.internal.Collections.fill(n, s, empty(), Queue::of);
    }
    ...
    public static <T extends @Nullable Object> Queue<T> fill(int n, T element) {
        return dev.zazr.collection.internal.Collections.fillObject(n, element, empty(), Queue::of);
    }
    ...
    public static <T extends @Nullable Object> Queue<Queue<T>> transpose(Queue<Queue<T>> matrix) {
        return dev.zazr.collection.internal.Collections.transpose(matrix, Queue::ofAll, Queue::of);
    }
    ...
    public Queue<T> enqueueAll(Iterable<? extends T> elements) {
        ...
        if (isEmpty() && elements instanceof Queue) {
            ...
            return dev.zazr.collection.List.ofAll(elements).foldLeft(this, Queue::enqueue);
        }
    }
    ...
    public Option<Integer> indexOfOption(T element) {
        return dev.zazr.collection.internal.Collections.indexOption(indexOf(element));
    }
    ...
    public Option<Integer> indexOfOption(T element, int from) {
        return dev.zazr.collection.internal.Collections.indexOption(indexOf(element, from));
    }
    ...
    public Option<Integer> indexOfSliceOption(Iterable<? extends T> that) {
        return dev.zazr.collection.internal.Collections.indexOption(indexOfSlice(that));
    }
    ...
    public Option<Integer> indexOfSliceOption(Iterable<? extends T> that, int from) {
        return dev.zazr.collection.internal.Collections.indexOption(indexOfSlice(that, from));
    }
    ...
    public Option<Integer> indexWhereOption(Predicate<? super T> predicate) {
        return dev.zazr.collection.internal.Collections.indexOption(indexWhere(predicate));
    }
    ...
    public Option<Integer> indexWhereOption(Predicate<? super T> predicate, int from) {
        return dev.zazr.collection.internal.Collections.indexOption(indexWhere(predicate, from));
    }
    ...
    public Option<Integer> lastIndexOfOption(T element) {
        return dev.zazr.collection.internal.Collections.indexOption(lastIndexOf(element));
    }
    ...
    public Option<Integer> lastIndexOfOption(T element, int end) {
        return dev.zazr.collection.internal.Collections.indexOption(lastIndexOf(element, end));
    }
    ...
    public Option<Integer> lastIndexOfSliceOption(Iterable<? extends T> that) {
        return dev.zazr.collection.internal.Collections.indexOption(lastIndexOfSlice(that));
    }
    ...
    public Option<Integer> lastIndexOfSliceOption(Iterable<? extends T> that, int end) {
        return dev.zazr.collection.internal.Collections.indexOption(lastIndexOfSlice(that, end));
    }
    ...
    public Option<Integer> lastIndexWhereOption(Predicate<? super T> predicate) {
        return dev.zazr.collection.internal.Collections.indexOption(lastIndexWhere(predicate));
    }
    ...
    /**
     * An unmodifiable {@link java.util.List} view of this Queue, in its order: nothing is copied, reads go through
     * to this Queue, which never changes, and every mutator of the view (including those of its iterators and
    ...
    private Queue<T> initOfFront() {
        ...
        dev.zazr.collection.List<T> newRear = dev.zazr.collection.List.empty();
    ...
    public Tuple2<Queue<T>, Queue<T>> partition(Predicate<? super T> predicate) {
        Objects.requireNonNull(predicate, "predicate is null");
        return toList().partition(predicate).map(dev.zazr.collection.List::toQueue, dev.zazr.collection.List::toQueue);
    }
    ...
    public Queue<Queue<T>> permutations() {
        return ofAll(toList().permutations().map(dev.zazr.collection.List::toQueue));
    }
    ...
    public Queue<T> shuffle() {
        return dev.zazr.collection.internal.Collections.shuffle(this, Queue::ofAll);
    }
    ...
    public Tuple2<Queue<T>, Queue<T>> span(Predicate<? super T> predicate) {
        Objects.requireNonNull(predicate, "predicate is null");
        return toList().span(predicate).map(dev.zazr.collection.List::toQueue, dev.zazr.collection.List::toQueue);
    }
    ...
    public Tuple2<Queue<T>, Queue<T>> splitAt(int n) {
        return toList().splitAt(n).map(dev.zazr.collection.List::toQueue, dev.zazr.collection.List::toQueue);
    }
    ...
    public Tuple2<Queue<T>, Queue<T>> splitAt(Predicate<? super T> predicate) {
        return toList().splitAt(predicate).map(dev.zazr.collection.List::toQueue, dev.zazr.collection.List::toQueue);
    }
    ...
    public Queue<T> take(int n) {
        ...
        if (n < frontLength) {
            ...
            return new Queue<>(front, dev.zazr.collection.List.empty());
        } else {
    ...
    public Queue<T> takeRight(int n) {
        ...
        if (n < rearLength) {
            ...
            return new Queue<>(rear.reverse(), dev.zazr.collection.List.empty());
        } else {
    ...
    private static final class InOrder<T extends @Nullable Object> implements java.util.Iterator<T> {
        ...
        private dev.zazr.collection.List<T> current;
        private dev.zazr.collection.List<T> rear;

        InOrder(dev.zazr.collection.List<T> front, dev.zazr.collection.List<T> rear) {
            this.current = front;
            this.rear = rear;
        }
        ...
        public boolean hasNext() {
            if (current.isEmpty() && !rear.isEmpty()) {
                ...
                rear = dev.zazr.collection.List.empty();
            }
