...
import dev.zazr.collection.internal.ListModule.Combinations;
import dev.zazr.collection.internal.ListModule.SplitAt;
...
public sealed interface List<T extends @Nullable Object> extends Traversable<T> permits List.Cons, List.Nil {
     ...
     * <p>
     * Complexity: O(m) for m inner elements in total: the elements go into an array, then the List is built from the
     * last to the first.
     *
