...
import com.guizmaii.zazr.collection.internal.IteratorModule.DistinctIterator;
import com.guizmaii.zazr.collection.internal.IteratorModule.GroupedIterator;
...
import static com.guizmaii.zazr.collection.internal.IteratorModule.BigDecimalHelper.asDecimal;
import static com.guizmaii.zazr.collection.internal.IteratorModule.CachedIterator;
import static com.guizmaii.zazr.collection.internal.IteratorModule.EmptyIterator;
...
public interface Iterator<T extends @Nullable Object> extends java.util.Iterator<T>, Iterable<T> {
    ...
    static <T extends @Nullable Object> Iterator<T> tabulate(int n, Function<? super Integer, ? extends T> f) {
        ...
        return com.guizmaii.zazr.collection.internal.Collections.tabulate(n, f);
    }
    ...
    static <T extends @Nullable Object> Iterator<T> fill(int n, Supplier<? extends T> s) {
        ...
        return com.guizmaii.zazr.collection.internal.Collections.fill(n, s);
    }
    ...
    static <T extends @Nullable Object> Iterator<T> fill(int n, T element) {
        ...
        return com.guizmaii.zazr.collection.internal.Collections.fillObject(n, element);
    }
